...
| --- | --- | --- | --- | --- |
| [001](../phases/phase-01-foundation/ADR-001-inscribed-act.md) | A document is an inscribed act with a `force` | 01-foundation | 2026-07-11 | superseded by 014 |
| [002](../phases/phase-02-theory/ADR-002-perlocution-typology.md) | `perlocution` is an open typology; `prove`/`decide` are `convince` | 02-theory | 2026-07-11 | superseded by 015 |
| [003](../phases/phase-02-theory/ADR-003-recommend-force.md) | Add `recommend` as the twelfth force | 02-theory | 2026-07-11 | accepted |
| [004](../phases/phase-02-theory/ADR-004-drop-diataxis.md) | Drop the `diataxis` field; derive it | 02-theory | 2026-07-11 | accepted |
| [005](../phases/phase-02-theory/ADR-005-verb-soft-summary.md) | `verb` is a soft summary; store only when it diverges | 02-theory | 2026-07-11 | accepted |
| [006](../phases/phase-03-reorganization/ADR-006-audience-model.md) | Audience = roles × `reader`; audience lives in `structure/` | 03-reorganization | 2026-07-11 | superseded by 017 (for this project) |
| [007](../phases/phase-03-reorganization/ADR-007-fractal-reorg.md) | Self-similar reorg: `write/` + `structure/`, forces by door | 03-reorganization | 2026-07-11 | accepted |
| [008](../phases/phase-03-reorganization/ADR-008-tree-axis-declaration.md) | Declare `axis` + `dominant-community` at each tree root | 03-reorganization | 2026-07-11 | accepted |
| [009](../phases/phase-03-reorganization/ADR-009-teach-onramp.md) | Add a `teach` on-ramp; enforce obligations by validation | 03-reorganization | 2026-07-11 | accepted |
...
| [014](../phases/phase-06-refoundation/ADR-014-adopt-refoundation.md) | Adopt the Ferraris-grounded refoundation of the theory | 06-refoundation | 2026-07-21 | accepted |
| [015](../phases/phase-06-refoundation/ADR-015-perlocution-floor.md) | Perlocution has no zero; forces are recognized cells | 06-refoundation | 2026-07-21 | accepted |
| [016](../phases/phase-06-refoundation/ADR-016-force-space.md) | know/do/govern is a gloss; recommend & entail are extensions | 06-refoundation | 2026-07-21 | accepted |
| [017](../phases/phase-06-refoundation/ADR-017-audience.md) | Audience: roles collapse, distance is the live axis, human/machine orthogonal | 06-refoundation | 2026-07-21 | accepted |
| [018](../phases/phase-06-refoundation/ADR-018-shelf.md) | Source shelf vs generated surface; the catalogue is the pivot | 06-refoundation | 2026-07-21 | accepted |
