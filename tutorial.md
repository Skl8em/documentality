...
You just used the catalogue. You don't need to understand every field yet — [`write/frontmatter.md`](write/frontmatter.md) explains them when you're curious.
...
1. Copy [`write/forces/govern-and-record/decide/template.md`](write/forces/govern-and-record/decide/template.md) to `decisions/ADR-001.md`.
...
- The *why* behind what you just did → [`write/concepts.md`](write/concepts.md).
- Writing a different kind of document → find its force via [`write/choosing.md`](write/choosing.md), then its folder in [`write/forces/`](write/forces/README.md).
- Where these files should actually live, and for how long → [`structure/README.md`](structure/README.md).
- Who you're writing for → [`structure/audience.md`](structure/audience.md).
