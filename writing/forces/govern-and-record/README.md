...
- **[mandate](mandate/README.md)** — *require*: institute a binding norm (`state`).
- **[commit](commit/README.md)** — *promise precisely*: bind the writer to a future, measurably (`state`).
- **[propose](propose/README.md)** — *argue*: open a future for deliberation, alternatives treated fairly (`state`).
